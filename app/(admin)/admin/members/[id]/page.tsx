    ...
    <div className="p-8 max-w-5xl">
        ...
        <div className="flex items-start gap-5 flex-wrap">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 mt-3 flex-wrap">
              ...
              {getMotivations(member.motivations).map(mot => (
                <span key={mot.key}
                  className={`inline-flex items-center gap-1 ${mot.chipBg} ${mot.chipText} border ${mot.chipBorder} text-xs font-inter font-semibold px-2 py-1 rounded`}>
      ...
      <div className="card-dark mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 text-sm font-inter">
          ...
          <Field icon={Target}   label="Objectif(s)"       value={getMotivations(member.motivations).map(m => m.label).join(', ') || null} missing="à compléter" />
